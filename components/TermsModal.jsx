        ...
        <Animated.View style={[styles.modalContainer, { transform: [{ scale: scaleAnim }] }]}>
          ...
          <ScrollView contentContainerStyle={styles.modalContentContainer}>
            <Text style={styles.modalText}>
              Welcome to FoodBuddy. By using this application, you agree to abide by our terms and
              conditions. FoodBuddy is provided "as is" without any warranties. We reserve the right
